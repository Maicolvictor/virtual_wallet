...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post wallets_url, params: { wallet: { account_id: @wallet.account_id, balance: @wallet.balance } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { account_id: @wallet.account_id, balance: @wallet.balance } }
